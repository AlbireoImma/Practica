### scheduled_task_server.ps1 - Francisco Abarca - 06-02-2019
## Script que dado un listado de IP (IP_SERVER.txt) y DNS (DNS_SERVER.txt) obtiene las tareas programadas de estos
...
$ruta = ".\log\TAREAS_PROGRAMADAS\tareas_SERVER_$(Get-Date -Uformat "%d%m%Y%H%M").csv" # Ruta para el archivo generado
